...
\end{figure}     
\noindent Simulations prove that our modeling choice is not the optimal one but could be a good starting point to develop eICIC optimization through Q-Learning, indeed the proposed algorithm performs poorly respect the baseline solutions.\\
...
\begin{footnotesize}
	\begin{table}[!htb]
		...
		\begin{tabular}{lcc} 
			...
			\multicolumn{1}{l|}{Random policy}       & \multicolumn{1}{c|}{$Prob[a_{incr}]$} 	& $1/3$                       \\ 
